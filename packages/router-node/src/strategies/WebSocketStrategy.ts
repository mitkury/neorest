import { ServerStrategy, CommunicationStrategy, MsgWrapper } from '@neorest/core';

/**
 * WebSocket strategy for Node.js
 */
export class WebSocketStrategy implements ServerStrategy {
  ...
  private setupSocketHandlers(): void {
    // Using the WebSocket API available in Node.js
  ...
  async connect(): Promise<void> {
    // This is a server-side WebSocket, so it's already connected
    this.connected = true;
    if (this.openCallback) {
      this.openCallback();
    }
