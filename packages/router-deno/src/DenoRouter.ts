// Direct imports for Deno compatibility
import { RouterBase, RouterOptions, ServerConnection } from '../../../router-core/src/index.ts';
import { ConnectionSecret, MsgWrapper } from '../../../core/src/index.ts';
import { WebSocketStrategy } from './strategies/WebSocketStrategy.ts';
import { HttpStrategy } from './strategies/HttpStrategy.ts';

/**
 * Deno-specific router options
 */
export interface DenoRouterOptions extends RouterOptions {
  port?: number;
  hostname?: string;
  certFile?: string;
  keyFile?: string;
 ...
 */
export class DenoRouter extends RouterBase {
  private options: DenoRouterOptions;
  ...
  public async listen(): Promise<void> {
    ...
    // The server is already listening after setupServer() in Deno
  }
